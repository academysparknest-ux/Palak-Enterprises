...
async function executeCompleteReset() {
  ...
  console.log('Step 1: Clearing any lingering locks...');
  await client.query(`
  ...
  console.log('Step 2: Deleting child order_files...');
  ...
  console.log('Step 3: Deleting child order_items...');
  ...
  console.log('Step 8: Deleting order storage documents...');
  ...
  console.log('\n================================================================');
  console.log('Step 9: Running complete forensic post-cleanup audit...');
  console.log('================================================================');
...
executeCompleteReset().catch(err => {
