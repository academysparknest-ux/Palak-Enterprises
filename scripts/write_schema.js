...
fs.writeFileSync(path.join(__dirname, '..', 'supabase', 'migrations', '20260817_security_and_expansion.sql'), migrationSql);
fs.writeFileSync(path.join(__dirname, '..', 'supabase', 'schema.sql'), migrationSql);
console.log('Migration and schema files generated successfully.');