      ...
      <div className="rounded-3xl border border-blue-100 bg-linear-to-br from-blue-900 via-[#123B70] to-slate-900 text-white p-6 sm:p-10 shadow-raised relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="inline-flex items-center gap-2 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/30 px-3.5 py-1 text-xs font-black tracking-wide uppercase">
            ...
            <span>⚡ Instant Online Services</span>
          </div>

          <h2 className="text-2xl sm:text-4xl font-black tracking-tight text-white leading-tight">
            {t.instantOnlineServices?.tagline || "Apna kaam khud karein — bina line mein wait kiye."}
          </h2>

          <p className="text-xs sm:text-sm text-slate-200 font-medium leading-relaxed">
            {t.instantOnlineServices?.subtext ||
              "File upload karein, printing options select karein, finishing add karein aur order submit karein. Palak Enterprises aapka order ready karega, taaki aap bina line mein wait kiye collect kar saken."}
          </p>

          <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-amber-200/90 font-semibold">
            <span className="inline-flex items-center gap-1.5 bg-white/10 px-3 py-1 rounded-lg border border-white/10">
              <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400 shrink-0" />
              <span>{currentLang === "hi" ? "ऑनलाइन ऑर्डर सबमिट करें" : "Submit Order Online"}</span>
            </span>
            <span className="inline-flex items-center gap-1.5 bg-white/10 px-3 py-1 rounded-lg border border-white/10">
              <Clock className="h-3.5 w-3.5 text-amber-400 shrink-0" />
              <span>{currentLang === "hi" ? "पालक टीम प्रिंट करेगी" : "Palak Prepares Job"}</span>
            </span>
            <span className="inline-flex items-center gap-1.5 bg-white/10 px-3 py-1 rounded-lg border border-white/10">
              <ShieldCheck className="h-3.5 w-3.5 text-blue-400 shrink-0" />
              <span>{currentLang === "hi" ? "दुकान से तुरंत कलेक्ट करें" : "Collect Ready Order"}</span>
            </span>
          </div>
        </div>
      </div>
