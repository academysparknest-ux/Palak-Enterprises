...
export default function ServicesPageContent() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="bg-navy py-12 sm:py-16 text-white relative overflow-hidden border-b border-white/10">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 opacity-15"
          style={{
            backgroundImage:
              "radial-gradient(circle at 80% 20%, #F97316 0, transparent 45%), radial-gradient(circle at 20% 80%, #15803D 0, transparent 45%)",
          }}
        />
