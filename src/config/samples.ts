...
export const sampleItems: SampleItem[] = [
  ...
  },
  {
    ...
    description: {
      en: "Official brand identity and modern vector logo design of Palak Enterprises Chakia.",
      hi: "पलक एंटरप्राइजेज चकिया का आधिकारिक आधुनिक एवं आकर्षक ब्रांड लोगो डिज़ाइन।",
    },
