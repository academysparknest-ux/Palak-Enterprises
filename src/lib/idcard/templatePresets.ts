...
export const SAMPLE_TEMPLATE_1_LAYOUT: TemplateLayout = {
  ...
  backgroundScale: 105,
  schoolLogoUrl: 'https://zofddiuswdtbqvqycezy.supabase.co/storage/v1/object/public/idcard-photos/logos/f16da48f-cba2-4353-bcfa-a5081ef94178/logo_1788102931205.png',
  isDoubleSided: true,
  templateType: 'double',
  headerSvg: null,
  footerSvg: null,
  ...
  fields: [
    {
      ...
      height: 13.0,
      visible: true,
      customText: 'https://zofddiuswdtbqvqycezy.supabase.co/storage/v1/object/public/idcard-photos/logos/f16da48f-cba2-4353-bcfa-a5081ef94178/logo_1788102931205.png',
      labelPrefix: '',
      borderRadius: 0,
    },
    {
