...
export interface TemplateSideLayout {
  ...
  footerGradientColors?: [string, string];
}

export interface TemplateLayout {
  fields: TemplateField[]; // Front side fields
  backgroundColor: string;
  headerSvg?: string; // SVG markup for header decoration
  footerSvg?: string; // SVG markup for footer decoration
  headerGradientColors?: [string, string]; // [primary, accent]
  footerGradientColors?: [string, string]; // [primary, accent]
