...
export const supabaseUrl = env.VITE_SUPABASE_URL || defaultUrl;
export const supabaseKey = env.VITE_SUPABASE_ANON_KEY || env.VITE_SUPABASE_PUBLISHABLE_KEY || defaultKey;
