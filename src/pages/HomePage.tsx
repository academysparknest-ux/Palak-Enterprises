  ...
  return (
    <div className="space-y-14 sm:space-y-20 pb-16">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 space-y-16 sm:space-y-20">
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link
                  key={cat.id}
                  to={cat.link}
                  className="group relative flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-slate-300 hover:shadow-lg"
                >
                  <div>
        ...
        {/* 7. Don't Have a Design? Studio Banner */}
        <section className="rounded-3xl border border-amber-200 bg-amber-50/60 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0 w-full md:w-auto">
            <Link
              to="/design-services"
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-[#123B70] px-5 py-3 text-xs sm:text-sm font-bold text-white hover:bg-[#0c274c] shadow-card transition-all"
            >
        ...
        <section className="space-y-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              { step: "5", titleEn: "Collect / Delivered", titleHi: "प्राप्त करें", descEn: "Pick up at Chakia store or get local delivery." },
            ].map((item) => (
              <div key={item.step} className="rounded-2xl border border-slate-200 bg-white p-5 text-left relative space-y-2">
        ...
        {/* 9. Why Choose Palak Enterprises Trust Grid */}
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 px-4 py-2.5 text-xs font-bold text-white transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 px-4 py-2.5 text-xs font-bold text-slate-700 transition-colors"
              >
