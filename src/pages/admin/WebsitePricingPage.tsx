              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    ...
                    <QuickRateRow label="Soft Binding (per book)" path={['documentPrinting', 'finishing', 'softBinding', 'price']} value={quickConfig.documentPrinting.finishing.softBinding?.price ?? 0} editingKey={editingQuickKey} setEditingKey={setEditingQuickKey} editVal={editQuickVal} setEditVal={setEditQuickVal} onSave={handleQuickEditSave} />
                    <QuickRateRow label="Hard Binding (per book)" path={['documentPrinting', 'finishing', 'hardBinding', 'price']} value={quickConfig.documentPrinting.finishing.hardBinding?.price ?? 0} editingKey={editingQuickKey} setEditingKey={setEditingQuickKey} editVal={editQuickVal} setEditVal={setEditQuickVal} onSave={handleQuickEditSave} />
